...
yay -Syyu
yay -S gnome-keyring visual-studio-code-bin pycharm-community-jre laigter rider rustrover webstorm material-maker-bin blockbench-bin phpstorm --noconfirm
