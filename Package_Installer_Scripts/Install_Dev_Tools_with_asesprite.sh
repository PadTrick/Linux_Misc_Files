...
yay -Syyu
yay -S gnome-keyring visual-studio-code-bin pycharm-community-jre laigter rider rustrover rustrover-jre webstorm material-maker-bin blockbench-bin phpstorm aseprite friction --noconfirm
...
echo "======================================================"
echo "To fix runtime errors with PHPStorm, RustRover and WebStorm"
